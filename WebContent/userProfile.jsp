                    ...
                    <div class="row m-l-0 m-r-0 mt-2 border border-dark shadow ">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <h5 class="f-w-600">Welcome <%=u.getUserName() %></h5>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class= "row justify-content-between">
                            	<h4 class=" col-3"><a  href="show_user_courses.htm" class=" w-100 btn btn-outline-primary" >Back</a></h4>
                            	<h4 class="col-3 "><a  href="prep_update_profile.htm" class=" w-100 btn btn-outline-primary" >Update</a></h4>
                            </div>
