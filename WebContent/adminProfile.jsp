                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <h5 class="f-w-600">welcome <%=admin.getAdminName() %></h5>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><%=admin.getAdminUserName() %></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Full Name</p>
                                        <h6 class="text-muted f-w-400"><%=admin.getAdminName() %></h6>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><%=admin.getAdminMail() %></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Mobile No</p>
                                        <h6 class="text-muted f-w-400"><%=admin.getAdminMobileNo() %></h6>
                                    </div>
